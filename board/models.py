...
class Test(models.Model):
    ...
    tamguFirstPercent = models.IntegerField(blank=True)
    ...
    tamguSecondPercent = models.IntegerField(blank=True)
    ...
    foreignPercent = models.IntegerField(blank=True)
